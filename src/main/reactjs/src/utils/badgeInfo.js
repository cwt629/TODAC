const badgeMap = new Map([
    ["뉴비", { image: 'https://kr.object.ncloudstorage.com/guest-hch/TODAC/badge/newbie.png', description: '회원가입 완료' }],
    ...
    ["신생 상담사", { image: 'https://kr.object.ncloudstorage.com/guest-hch/TODAC/badge/newcounselor.png', description: '상담사 커스텀 완료' }],
    ["나도 몰랐던 나의 이야기", { image: 'https://kr.object.ncloudstorage.com/guest-hch/TODAC/badge/mystory.png', description: '상담 후 진단서 발급' }]
]);
