    ...
    return (
        <div>
            ...
            <div className='myupdatemain'>
                ...
                <button className='bg_blue bor_blue1' onClick={() => nav("charge")}>
                    충전
                </button>
                <PointLogo />
                <div className='point' style={{ textAlign: "center" }}>
                    ...
                    <h4 className='mt_45'>
                        보유 포인트 : <span style={{ color: "#FF7170" }}>{member.point?.toLocaleString()}</span>
                    </h4>
                </div>
                ...
                <button className='bg_blue bor_blue1'>더보기</button>
            </div>
        </div>
    );
};
